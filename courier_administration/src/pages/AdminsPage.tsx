import {useAdmins} from "../hooks/AdminsHook";
import React from "react";
import {Col, Container, Row} from "react-bootstrap";
import {Navigation} from "../components/nav/Navigation";
import {ModalWindow} from "../components/modal/ModalWindow";
import {UpdateAdmin} from "../CUD/updates/UpdateAdmin";
...
import {SearchAdmins} from "../CUD/search/SearchAdmins";
import {InsertAdmins} from "../CUD/insert/InsertAdmins";

export function AdminsPage() {

    const {generatePropsForDBAccess} = useAdmins();
    ...
    return (
        <div style={{minHeight: "100vh", backgroundColor: "#393646"}} className="pb-3">
            ...
            <UpdateAdmin obj={props.updateObj} setObj={props.setUpdateObj} updateHandler={props.updateHandler}
                         show={props.showUpdateModal}
                         handleClose={props.handleCloseUpdateModal}/>
            <Container className="standard mt-3 rounded">
                <Row className="pt-3">
                    <div>
                        <h2 style={{textAlign: "center"}}>Страница управления данными пользователей</h2>
                    </div>
                </Row>
                <Row>
                    <Col className="col-6">
                        <Container className="pt-3">
                            <Row>
                                <Col>
                                    <SearchAdmins searchHandler={props.searchHandler}
                    ...
                    <Col className="col-6">
                        <Container className="pt-3">
                            <Row>
                                <InsertAdmins insertHandler={props.insertHandler}/>
                            </Row>
                        </Container>
                    </Col>
                </Row>
