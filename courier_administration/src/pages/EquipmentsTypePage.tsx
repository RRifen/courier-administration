...
export function EquipmentsTypePage() {
    const {generatePropsForDBAccess} = useEquipmentTypes();
    ...
    return (
        <div style={{minHeight: "100vh", backgroundColor: "#393646"}} className="pb-3">
            ...
            <UpdateEquipmentType obj={props.updateObj} setObj={props.setUpdateObj} updateHandler={props.updateHandler}
                              show={props.showUpdateModal}
                              handleClose={props.handleCloseUpdateModal}/>
            <Container className="standard mt-3 rounded">
                <Row className="pt-3">
                    <div>
                        <h2 style={{textAlign: "center"}}>Типы курьерского оборудования</h2>
                    </div>
                </Row>
                <Row>
                    <Col className="col-6">
                        <Container className="pt-3">
                            <Row>
                                <Col>
                                    <SearchEquipmentTypes   searchHandler={props.searchHandler}
                    ...
                    <Col className="col-6">
                        <Container className="pt-3">
                            <Row>
                                <InsertEquipmentTypes insertHandler={props.insertHandler}/>
                            </Row>
                        </Container>
                    </Col>
                </Row>
