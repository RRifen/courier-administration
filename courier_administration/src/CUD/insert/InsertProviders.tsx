...
export function InsertProviders({ insertHandler } : InsertAdminsProps) {
    ...
    return (
        <form className="standard p-3 rounded">
            ...
            <FormGroup className="row">
                <label htmlFor="adminIdInsert" className="col-3 col-form-label text-end">Id админа:</label>
                <div className="col-sm-9">
                    <input value={newProvider.admin_id} type="number" className="form-control" id="adminIdInsert"
                           placeholder="Id админа"
                           onChange={(e) => setNewProvider({...newProvider, admin_id: e.target.value})}
                    />
                </div>
            </FormGroup>
